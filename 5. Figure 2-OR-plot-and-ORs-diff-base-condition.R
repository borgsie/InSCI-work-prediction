...
or_plt <- odds_rat %>% ggplot() +
  ...
  scale_x_discrete (labels = c("Masters/PhD education: 3.01 (1.63, 5.44)", "Married: 1.68 (1.13, 2.49)", "Diploma education: 1.51 (0.97, 2.63)",
                               ...
                               "Pre-injury job: 1.18 (0.88, 1.92)", "Separated: 1.14 (0.85, 1.90)", "Time since injury: 1.12 (0.97, 1.34)",
                               "Tetraplegia incomplete: 1.11 (0.89, 1.56)", "Health, neither: 1.10 (0.89, 1.51)", "Post-2nd education: 1.08 (0.83, 1.58)",
                               ...
                               "Remote area: 0.93 (0.66, 1.18)", ">2 Hospitalisations: 0.92 (0.56, 1.26)", "Good health: 0.91 (0.62, 1.17)",
